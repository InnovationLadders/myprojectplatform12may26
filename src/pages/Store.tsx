      ...
      >
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 mb-4">
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-bold">{t('store.title')}</h1>
              <p className="opacity-90 text-sm md:text-base">{t('store.subtitle')}</p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full lg:w-auto">
            {isAdmin && (
              <button
                ...
                className="w-full sm:w-auto bg-white bg-opacity-20 text-white px-3 md:px-4 py-2.5 md:py-2 rounded-lg md:rounded-xl hover:bg-opacity-30 transition-all duration-200 backdrop-blur-sm flex items-center justify-center gap-2 text-sm md:text-base whitespace-nowrap"
              >
            ...
            {!isAdminView && (
              <>
                <div className="relative">
                  <button className="w-full sm:w-auto bg-white bg-opacity-20 text-white px-3 md:px-4 py-2.5 md:py-2 rounded-lg md:rounded-xl hover:bg-opacity-30 transition-all duration-200 backdrop-blur-sm flex items-center justify-center gap-2 text-sm md:text-base whitespace-nowrap">
                ...
                <div className="relative">
                  <Link
                    to="/cart"
                    className="w-full sm:w-auto bg-white text-purple-600 px-3 md:px-4 py-2.5 md:py-2 rounded-lg md:rounded-xl hover:bg-opacity-90 transition-all duration-200 flex items-center justify-center gap-2 text-sm md:text-base whitespace-nowrap"
                  >
            ...
            {isAdmin && isAdminView && (
              <div className="flex flex-col sm:flex-row gap-2">
                <button
                  ...
                  className="w-full sm:w-auto bg-white text-purple-600 px-4 md:px-6 py-2.5 md:py-3 rounded-lg md:rounded-xl font-medium hover:bg-opacity-90 transition-all duration-200 flex items-center justify-center gap-2 text-sm md:text-base whitespace-nowrap"
                >
                ...
                <button
                  ...
                  className="w-full sm:w-auto bg-red-500 text-white px-4 md:px-6 py-2.5 md:py-3 rounded-lg md:rounded-xl font-medium hover:bg-red-600 transition-all duration-200 flex items-center justify-center gap-2 text-sm md:text-base whitespace-nowrap"
                >
              ...
              <div className="flex gap-2">
                {isAdminView ? (
                  <>
                    <button
                      onClick={() => handleEditItem(item)}
                      className="flex-1 bg-blue-500 text-white py-2.5 px-4 rounded-lg md:rounded-xl hover:bg-blue-600 transition-colors font-medium flex items-center justify-center gap-2 text-sm md:text-base"
                    >
                      <Edit className="w-4 h-4" />
                      تعديل
                    </button>
                    <button
                      onClick={() => handleDeleteItem(item)}
                      className="px-3 md:px-4 py-2.5 bg-red-500 text-white rounded-lg md:rounded-xl hover:bg-red-600 transition-colors"
                    >
                      <Trash2 className="w-4 h-4" />
                    </button>
                  </>
                  ...
                  <>
                    {cart[item.id] ? (
                      <div className="flex items-center gap-2 flex-1">
                        ...
                        <span className="flex-1 text-center font-medium text-sm md:text-base">{cart[item.id]}</span>
                        <button
                      ...
                      <button
                        ...
                        className="flex-1 bg-purple-500 text-white py-2.5 px-4 rounded-lg md:rounded-xl hover:bg-purple-600 transition-colors font-medium disabled:bg-gray-300 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm md:text-base"
                      >
