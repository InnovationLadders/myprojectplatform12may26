...
import { getTextValue, matchesSearchTerm } from '../../utils/multiLangHelper';
                    ...
                    <div className="flex items-center">
                      <div className="flex-shrink-0 h-10 w-10 rounded-md overflow-hidden">
                        <img
                          ...
                          alt={getTextValue(idea.title)}
                          className="h-10 w-10 object-cover"
                        />
                      </div>
                      <div className="mr-4">
                        <div className="text-sm font-medium text-gray-900">{getTextValue(idea.title)}</div>
                        <div className="text-sm text-gray-500 line-clamp-1">{getTextValue(idea.description)}</div>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
