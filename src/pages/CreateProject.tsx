        ...
        try {
          ...
          if (idea) {
            ...
            setFormData(prev => ({
              ...
              objectives: idea.objectives?.length ? idea.objectives : [''],
              materials: idea.materials?.length ? idea.materials : [''],
              steps: idea.steps?.length ? idea.steps : ['']
            }));
          } else {
          ...
          <div className="bg-green-50 border border-green-200 rounded-xl p-4 mb-6 flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-green-700 text-sm">
                تم تحميل بيانات فكرة المشروع "{usingIdea.title}" وملء النموذج. يمكنك تعديل أي من هذه البيانات حسب احتياجاتك.
              </p>
            </div>
          </div>
        )}
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="flex-1">
            <h1 className="text-3xl font-bold text-gray-800 mb-2">
              {usingIdea ? `إنشاء مشروع من فكرة: ${usingIdea.title}` : t('createProject.title')}
            </h1>
