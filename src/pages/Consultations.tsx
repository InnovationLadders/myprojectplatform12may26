      ...
      >
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-4">
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-bold">{t('consultations.title')}</h1>
              <p className="opacity-90 text-sm md:text-base">{t('consultations.subtitle')}</p>
            </div>
          </div>

          <button
            onClick={() => setShowRequestModal(true)}
            className="w-full sm:w-auto bg-white text-blue-600 px-4 md:px-6 py-2.5 md:py-3 rounded-lg md:rounded-xl font-medium hover:bg-opacity-90 transition-all duration-200 flex items-center justify-center gap-2 text-sm md:text-base whitespace-nowrap"
          >
          ...
          <div className="p-6">
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mt-4 pt-4 border-t border-gray-200">
                      ...
                      <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                        {consultation.status === 'scheduled' && (
                          <>
                            <button
                              ...
                              className="w-full sm:w-auto px-3 md:px-4 py-2.5 md:py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors text-xs md:text-sm flex items-center justify-center gap-2 whitespace-nowrap"
                            >
                            ...
                            <button
                              ...
                              className="w-full sm:w-auto px-3 md:px-4 py-2.5 md:py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors text-xs md:text-sm whitespace-nowrap"
                            >
                        ...
                        {consultation.status === 'completed' && !consultation.rating && (
                          <button
                            onClick={() => setSelectedConsultation(consultation.id)}
                            className="w-full sm:w-auto px-3 md:px-4 py-2.5 md:py-2 bg-yellow-500 text-white rounded-lg hover:bg-yellow-600 transition-colors text-xs md:text-sm whitespace-nowrap"
                          >
            ...
            {filteredConsultations.length === 0 && (
              <div className="text-center py-12">
                ...
                <h3 className="text-lg md:text-xl font-semibold text-gray-800 mb-2">{t('consultations.noConsultations')}</h3>
                <p className="text-sm md:text-base text-gray-600 mb-4">{t('consultations.startByRequesting')}</p>
                <button
                  onClick={() => setShowRequestModal(true)}
          ...
          <div className="p-6">
                ...
                {consultants.map((consultant, index) => (
                  ...
                  >
                      ...
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium text-green-600">
                          {consultant.hourlyRate === null
                            ? 'السعر غير محدد'
                            : `${consultant.hourlyRate} ${t('search.pricePerHour')}`}
                        </span>
                      </div>
                    </div>
                    ...
                    <button
                      ...
                      className="w-full bg-blue-500 text-white py-2.5 md:py-2 rounded-lg md:rounded-xl hover:bg-blue-600 transition-colors font-medium text-sm md:text-base"
                    >
            ...
            {consultants.length === 0 && (
              <div className="text-center py-12">
                ...
                <h3 className="text-lg md:text-xl font-semibold text-gray-800 mb-2">{t('consultations.noConsultants')}</h3>
                <p className="text-sm md:text-base text-gray-600 mb-4">{t('consultations.noConsultantsAvailable')}</p>
                <Link
                  to="/search"
                  className="inline-block w-full sm:w-auto px-4 md:px-6 py-2.5 md:py-2 bg-blue-500 text-white rounded-lg md:rounded-xl hover:bg-blue-600 transition-colors text-sm md:text-base"
                >
