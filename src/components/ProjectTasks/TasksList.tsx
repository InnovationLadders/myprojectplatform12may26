...
import { Clock, CheckCircle, AlertTriangle, Flag, User, Calendar } from 'lucide-react';
...
interface TasksListProps {
  projectId: string;
  tasks: Task[]; // Receive tasks directly
  students: any[]; // Receive students directly
}

const TasksList: React.FC<TasksListProps> = ({ tasks, students }) => {
