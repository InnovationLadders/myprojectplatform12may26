...
export const ReportTable: React.FC<ReportTableProps> = ({
  ...
  const placeholder = searchPlaceholder || t('reportTable.searchPlaceholder');
  ...
  const exportToExcel = () => {
    try {
      ...
      alert(t('reportTable.exportError'));
    }
  };
    ...
    <div className={`bg-white rounded-2xl shadow-lg overflow-hidden ${className}`}>
      ...
      <div className="p-6 border-b border-gray-200">
        ...
        <div className="mt-2 text-sm text-gray-600">
          {t('reportTable.showing')} {processedData.length} {t('reportTable.of')} {data.length} {t('reportTable.items')}
        </div>
      </div>
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {processedData.length > 0 ? (
              ...
              <tr>
                ...
                >
                  {searchTerm ? t('reportTable.noResults') : t('reportTable.noData')}
                </td>
              </tr>
            )}
          </tbody>
