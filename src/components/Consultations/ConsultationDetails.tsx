...
import { X, MessageCircle, Calendar, Clock, CircleCheck as CheckCircle, Circle as XCircle, CircleAlert as AlertCircle, Eye, Download, Upload, Lightbulb, Cpu, Palette, BookOpen, User } from 'lucide-react';
